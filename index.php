...
<body>
    ...
    <form action="core/handleForms.php" method="POST">
        <input type="hidden" name="developerID" value="<?php echo isset($_POST['developerID']) ? $_POST['developerID'] : ''; ?>">
        ...
        <p><label for="favoriteTool">Favorite Tool</label> <input type="text" name="favoriteTool"></p>
        <p><label for="frameworksUsed">Frameworks Used</label> <input type="text" name="frameworksUsed"></p>
    ...
    <table>
        ...
        <tr>
            ...
            <td><?php echo $row['favoriteTool']; ?></td>
            <td><?php echo $row['frameworksUsed']; ?></td>
            <td><?php echo $row['projects']; ?></td>
            <td><?php echo $row['dateRegistered']; ?></td>
            <td>
                <a href="editdeveloper.php?developerID=<?php echo $row['developerID']; ?>">Edit</a>
                <a style="color:red;" href="deletedeveloper.php?developerID=<?php echo $row['developerID']; ?>">Delete</a>
            </td>
        </tr>
        <?php } ?>
    </table>
